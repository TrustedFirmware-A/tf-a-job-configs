...
ARM_GENERIC_TIMER_GERRIT_PROJECT="${ARM_GENERIC_TIMER_GERRIT_PROJECT:-rust-spmc/arm-generic-timer}"
ARM_CCI_GERRIT_PROJECT="${ARM_CCI_GERRIT_PROJECT:-rust-spmc/arm-cci}"
