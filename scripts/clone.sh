...
git config --global --add url."https://review.trustedfirmware.org/mirror/mbed-tls.git".insteadOf "https://github.com/ARMmbed/mbedtls"
...
git config --global --add url."https://review.trustedfirmware.org/mirror/mbed-tls-framework.git".insteadOf "https://github.com/Mbed-TLS/mbedtls-framework"
...
MEMORY_USAGE_ANALYSER_GERRIT_PROJECT="${MEMORY_USAGE_ANALYSER_GERRIT_PROJECT:-${GERRIT_PROJECT_PREFIX}shared/memory-usage-analyser}"
...
MEMORY_USAGE_ANALYSER_GERRIT_REFSPEC="${MEMORY_USAGE_ANALYSER_GERRIT_REFSPEC:-${REFSPEC_MAIN}}"
...
declare -A repos_map=(
  ...
  ["memory-usage-analyser"]="${GERRIT_HOST};${MEMORY_USAGE_ANALYSER_GERRIT_PROJECT};${MEMORY_USAGE_ANALYSER_GERRIT_REFSPEC}"
